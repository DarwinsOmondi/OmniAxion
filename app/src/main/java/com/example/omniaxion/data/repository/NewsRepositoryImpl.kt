...
class NewsRepositoryImpl @Inject constructor(
    ...
    override suspend fun getNewsFeed(perPage: Int, page: Int): Result<List<NewsArticle>> {
        return try {
            Timber.d("Fetching news feed: page=$page, perPage=$perPage")
            val response = apiService.getEverything(perPage, page)
